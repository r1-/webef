...
void get_options(int argc, char **argv, t_options *opt)
{
          ...
          while( (c = getopt(argc,argv,"f:r:t:n:s:H:B:m:p:P:E:e:c:k:R:qhviAd23")) != -1 ) {
                    ...
                    case 't' :
                              ...
                              break;
                    case 's' :
                              opt->wait = (unsigned int) atoi(optarg);
                              break;
                    case 'n' :
                              parse_range_size(optarg, opt);
                              break;
                    case 'E' :
                              opt->encod=(short)atoi(optarg);
                              break;
                    case 'H' :
                              if(opt->headers==NULL) {
                              ...
                              break;
                    case 'P' :
                              parse_post(optarg, opt);
                              break;
                    case 'p' :
                              parse_proxy(optarg, opt);
                              break;
                    case 'm' :
                              opt->method = calloc(strlen(optarg)+1,1);
                    ...
                    case 'i' :
                              ...
                              break;
                    case 'c' :
                              parse_cert(optarg, opt);
                              break;
                    case 'k' :
                              parse_key(optarg, opt);
                              break;
                    case '2' :
                              opt->ssl_version=2;
                              break;
                    ...
                    case 'e' :
                              ...
                              break;
                    case 'v' :
                              fprintf(stderr,"webfuzzer v%s (http://%s)\n",VERSION, URL);
                              exit(0);
                              break;
                    case 'A' :
                              if(!opt->inj)
          ...
          if (optind < argc ) {
                    ...
                    if(opt->url.ssl) {
                              ...
                              case '2':
                                        opt->ctx=SSL_CTX_new(SSLv2_method());
                                        break;
                              case '3' :
                                        opt->ctx=SSL_CTX_new(SSLv3_method());
                                        break;
                              case '0' :
                              default :
